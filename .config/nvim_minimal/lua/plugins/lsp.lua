local execute_simple_stuff = function()
  vim.api.nvim_create_autocmd("LspAttach", {
    ...
    callback = function(e)
      ...
      map("gl", function() telescope.diagnostics({ bufnr = e.buf }) end, "Go to line diagnostics")
      map("gL", function() telescope.diagnostics({ bufnr = 0 }) end, "Go to buffer diagnostics")
